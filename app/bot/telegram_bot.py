...
from app.bot.handlers.crypto import crypto_handler, crypto_detail_handler, crypto_audit_handler
...
def create_bot() -> Application:
    ...
    app.add_handler(CommandHandler("audit", crypto_audit_handler))
    app.add_handler(CommandHandler("jurnal", crypto_audit_handler))
    app.add_handler(CommandHandler("forensic", crypto_audit_handler))
